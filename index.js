...
O menu vip esta em desenvolvimento🥱
           ...
           await loli.sendMessage(from, {image: fs.readFileSync('./loli/image/menu.jpg'), caption: menu8, contextInfo: {
            ...
            sourceUrl: `https://instagram.com/sandro_mg1`, 
            mediaType: 2
            }}})
...
"thumbnail": fs.readFileSync('./loli/image/fototeta.jpg'),
"itemCount": 1000000000000,
"status": "INQUIRY",
"surface": "CATALOG",
"message": `𝑺𝑨𝑵𝑫𝑹𝑶-𝑩𝑶𝑻⃟🥂`,
...
return (`ola sou a lolita bot criador (sandro)`)
break
//==============JOGOS===========\\
